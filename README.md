...
> Note: The frontend of this project was entirely generated by Copilot, while the backend was manually written by me, with prompts continuously refined during the generation process to achieve better results. Although the current version is quite stable, some minor issues may still exist; feel free to submit issues or pull requests to help improve it!
